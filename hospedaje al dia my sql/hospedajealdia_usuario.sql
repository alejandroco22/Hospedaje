...
CREATE TABLE `usuario` (
  ...
  KEY `idReunionUsuario` (`idReunionUsuario`),
  KEY `idSedeUsuario` (`idSedeUsuario`),
  CONSTRAINT `usuario_ibfk_1` FOREIGN KEY (`idRolUsuario`) REFERENCES `rol` (`idRol`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `usuario_ibfk_2` FOREIGN KEY (`idSedeUsuario`) REFERENCES `sede` (`idSede`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `usuario_ibfk_3` FOREIGN KEY (`idReunionUsuario`) REFERENCES `reunion` (`idReunion`) ON DELETE CASCADE ON UPDATE CASCADE
